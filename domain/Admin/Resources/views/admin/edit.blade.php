<x-admin::layouts.logged 
    ...
    <div class="row">
        <div class="col-md-3">
            @include('admin::admin.section.box-profile', ['page' => 'edit'])
        </div>
        <div class="col-md-9">
            <form method="post" action="{{ route('app.admin.admins.update', ['id' =>$admin ->_id])}}" class="card"
                ...
                <div class="card-body">
                    @include('admin::admin.section.form')
                </div>
            </form>
        </div>
    </div>
