<nav class="main-header navbar navbar-expand navbar-light">
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('app.home') }}" target="_blank" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="fas fa-moon switch-theme"></i>
            </a>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="#" class="dropdown-item">
                    <i class="fas fa-user-circle mr-2"></i> {{ __('pages.profile.name') }}
                </a>
                <div class="dropdown-divider"></div>
                <a href="{{ route('app.admin.auth.logout') }}" class="dropdown-item">
