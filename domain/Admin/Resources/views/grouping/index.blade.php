...
<x-admin::layouts.logged title="{{ trans_choice('entity.category', 2) }}"
    description="{{ trans_choice('entity.category', 2) }}" section="">
    ...
    <x-customponents-section name="header_action">
        ...
        <a href="{{ route('app.admin.groupings.deleted') }}" class="btn btn-sm btn-dark">
    ...
    <div class="card">
        ...
        <div class="card-body">
            @include('admin::grouping.section.table', ['displayed' => 'index'])
        </div>
    </div>
